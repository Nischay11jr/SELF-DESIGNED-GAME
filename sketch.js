...
function preload(){
  trex_running =   loadImage("Idle1.png");
  trex_collided = loadImage("Dead15.png");
  trex_jumping = loadImage("Jump6.png")
  ...
  obstacle1 = loadImage("tiger.png");
  obstacle2 = loadImage("snake.png");
  obstacle3 = loadImage("monkey.png");
  obstacle4 = loadImage("spider.png");
  obstacle5 = loadImage("elephant.png");
  obstacle6 = loadImage("lion.png");
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") & trex.y >= 125){
      trex.velocityY = -12;
      trex.changeImage("jumping", trex_jumping);
      jumpSound.play();
    }
